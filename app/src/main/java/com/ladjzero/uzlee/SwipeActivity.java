...
public class SwipeActivity extends BaseActivity {
    ...
    private int layerColor = Color.parseColor("#CC000000");
                ...
                if (swipeAnyWhere) {
                    switch (ev.getAction()) {
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            if (dx > 0 && (dy == 0f || Math.abs(dx / dy) > 1) && (dx * dx + dy * dy > touchSlop * touchSlop)) {
                                downX = ev.getX();
                                downY = ev.getY();
                                currentX = downX;
                                currentY = downY;
...
//            } else {
//                if (content.getX() > screenWidth / 3
//                        && v * duration / 1000 + content.getX() > screenWidth / 3) {
//                    animateFinish(false);
//                } else {
//                    animateBack(true);
//                }
...
//        }
	...
	public interface OnSwipeToggle {
		void setEnableSwipe(boolean enableSwipe);
	}
}
